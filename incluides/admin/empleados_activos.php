<?php 
  ...
  if($_SESSION['rol'] == NULL){
    ...
    include "../modal/editar/modal_editar_empleados.php";
?>  
<div class="col-md-5 col-xl-11 grid-margin stretch-card" style="top: 20px;">
    <div class="col-md-10 grid-margin stretch-card">
      <h2 class="card-title" style="color:black ;">Empleados Activos</h2> 
    </div> 
    <form>
  ...
  <div class="container-fluid py-4">
    <div class="table-responsive">
      <table class="table" id="table">
        ...
        <tbody id="myTable">
          <?php
            $query = mysqli_query($conexion, "SELECT * FROM empleados AS e LEFT JOIN  departamento AS d ON e.id_departamento = d.id_departamento WHERE status = 1  ORDER BY id_empleado ");
              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                <tr>
                  ...
                  <td><a data-toggle="modal" href="#modal_editar_empleados" class="btn btn-primary" style="border-radius: 15px;" onclick='editar_empleado(
                    ...
                    "<?php echo $data["h_s"];?>",
                    "<?php echo $data["h_d"];?>",
                    "<?php echo $data["descanso_e"];?>",
                    "<?php echo $data["checador"];?>"
                    )'>Editar</a> 
                  <a onclick="return confirm('Estás seguro que deseas eliminar a <?php echo $data['nombre_empleado'] ?> <?php echo $data['apellido_paterno'] ?> <?php echo $data['apellido_materno'] ?>');" href="../base_datos/eliminar/eliminar_empleado.php?id=<?php echo $data['id_empleado'] ?>" class="btn btn-danger" style="border-radius:20px">Eliminar </a>
    ...
    document.getElementById('descanzo_e_editar').value = descanso_e
    document.getElementById('checador_editar').value = checador;
