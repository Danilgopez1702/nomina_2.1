...
$sql =  mysqli_query($conexion,"SELECT  `id_o`, `id_empleado`, `monto_o`, `razon_o` FROM `otros_temp`");
...
while ($data = mysqli_fetch_assoc($sql)){
    ...
    $sql_update = mysqli_query($con, "UPDATE otros SET status_otros = 1 WHERE  id_empleado = $id_empleado_real");
    $x++;
