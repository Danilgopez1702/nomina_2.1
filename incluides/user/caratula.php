<?php 
    ...
    if($_SESSION['rol'] == NULL){
        ...
        $query_v = mysqli_query($conexion, "SELECT * FROM vacaciones WHERE id_empleado = $id");
        ...
        <div class="tabs col-sm">
            <div class="tab-container">
                                            ...
                                            while ($data = mysqli_fetch_assoc($query_a)) { ?>
                                                ...
                                                <td><?php echo $data['fecha_asistencia']; ?></td>
                                                    ...
                                                    <td>
                                                        ...
                                                        >Editar</a>
                                                        <a href="../base_datos/eliminar/eliminar_falta.php?id=<?php echo $data['id_asistencia']; ?>&ide=<?php echo $data['id_empleado']; ?> " class="btn btn-danger" style="border-radius:20px">Eliminar </a>
                                                    </td>
                ...
                <div id="tab2" class="tab"> 
                    <a href="#tab2"><h4>Vacaciones</h4></a>
                    <div class="tab-content">
                        <br>
                        <div class="container col-sm">
                            <div class="row">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a data-toggle="modal" href="#modal_editar_vacaciones" class="btn btn-primary" style="border-radius:20px" 
                                                            ...
                                                            >Editar</a>
                                                        <a href="../base_datos/eliminar/eliminar_vacacion.php?id=<?php echo $data['id_vacaciones']; ?>&ide=<?php echo $data['id_empleado']; ?> " class="btn btn-danger" style="border-radius:20px">Eliminar </a>
                                                    </td>
                                                </tr>
                                    <?php 
                                            }
                                                ...
                                                <tr>
                                                    ...
                                                    <a data-toggle="modal" href="#modal_editar_prestamos" class="btn btn-primary" style="border-radius:20px" 
                                                        onclick='editar_prestamo(
                                                            ...
                                                            >Editar</a>
                                                        <a href="../base_datos/eliminar/eliminar_prestamo.php?id=<?php echo $data['id_prestamo']; ?>&ide=<?php echo $data['id_empleado']; ?> " class="btn btn-danger" style="border-radius:20px">Eliminar </a>
                                                    </td>
                                                </tr>
                                    <?php 
                                            }
                                            ...
                                            while ($data = mysqli_fetch_assoc($query_i)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        >Editar</a>
                                                        <a href="../base_datos/eliminar/eliminar_infonavit.php?id=<?php echo $data['id_infonavit']; ?>&ide=<?php echo $data['id_empleado']; ?> " class="btn btn-danger" style="border-radius:20px">Eliminar </a>
                                                    </td>
                                                </tr>
                                    <?php 
                                            }
                                            ...
                                            while ($data = mysqli_fetch_assoc($query_h)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        >Editar</a>
                                                        <a href="../base_datos/eliminar/eliminar_extras.php?id=<?php echo $data['id_extra']; ?> && ide=<?php echo $data['id_empleado']; ?> " class="btn btn-danger" style="border-radius:20px">Eliminar </a>
                                                    </td>
                                                </tr>
                                    <?php 
                                            }
                                            ...
                                            while ($data = mysqli_fetch_assoc($query_o)) { ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        >Editar</a>
                                                        <a href="../base_datos/eliminar/eliminar_otros.php?id=<?php echo $data['id_otros']; ?>&ide=<?php echo $data['id_empleado']; ?> " class="btn btn-danger" style="border-radius:20px">Eliminar </a>
                                                    </td>
                                                </tr>
                                    <?php 
                                            }
...
<?php
        ...
        header('location: ../admin/caratula.php');
      } 
