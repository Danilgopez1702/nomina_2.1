...
$url_oficina = "10.2.3.10/ISAPI/AccessControl/AcsEvent?format=json";
$username = "admin";
$password = "CARLOS1985";
...
$sql_eliminar =  mysqli_query($con,"DELETE FROM `previsualizacion`");
...
header('location: ./previsualizacion_almacen.php');
?>