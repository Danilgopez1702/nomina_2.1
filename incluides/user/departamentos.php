...
?>
            ...
            if ($result > 0) {
              while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <a data-toggle="modal" href="#modal_editar_departamento"  class="btn btn-primary btn-rounded" 
                    ...
                    "<?php echo $data["horario_departamento"];?>",
  ...
  function editar_departamento(id_departamento,nombre_departamento,horario_departamento,turno_departamento)
    {   
    ...
    document.getElementById('editar_horario').value = horario_departamento;
