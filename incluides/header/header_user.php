          ...
          <li class="nav-item menu-items">
            ...
            <div class="collapse" id="auth">
              <ul class="nav flex-column sub-menu">
                <li class="nav-item menu-items"> <a class="nav-item" href="../user/empleados_activos.php"> Empleados Activos </a></li>
                <li class="nav-item menu-items"> <a class="nav-item" href="../user/empleados_inactivos.php"> Empleados Inactivos </a></li>
              </ul>
            </div>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="../user/guardia.php">
              <span class="menu-icon">
